...
ID ={'L0GW01_ULS_BE_ver5'}; % API Loads received 2020-11-06



ID ={'L0GW01_BE_ver5_selfweight'}; % Self weight based on L1GW01 rev 00
...
plots.res_vs_pilelength         = 1;        % 1 = yes, 0 = no
plots.normal_force_axial        = 0;        % Normal force plot. 1 = yes, 0 = no
plots.UR_axial                  = 1;        % utilization ratio for axial capacity
...
soil.zpeak                      = 0.055;    % usually = pile.diameter*0.01
soil.zres                       = 2;        % usually = 2
soil.zpeak_Qz                   = 0.55;     % usually = pile.diameter*0.1
soil.tres                       = 0.7;      % Usually = 0.7 - 0.9
%--------------------------------------------------------------------------
%% Calculation settings (torsional)
%--------------------------------------------------------------------------
settings.torsion                = 1;        % calculate torsional stiffness? 1 = yes, 0 = no. settings.axial_loading must also be set to 1
%--------------------------------------------------------------------------
