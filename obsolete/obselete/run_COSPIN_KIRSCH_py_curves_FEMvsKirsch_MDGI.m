...
zone=1;
ID_Soil_in_db='EW2 zone 4 LB';

WTGlocation={'25'};

ID ={'Location_69_kirsch'}; % API
...
data.prepared_by                = 'MDGI';   %  Initials of preparer
data.zoneID                     =ID_Soil_in_db;
data.id                         =['FD2-',WTGlocation{loc}]; % Id to store into the database   
data.revision.global            = 00;   % global revision no. for selected location to be used,
...
data.table_springs              = 'BE' ;        % 'char', 'LB', 'UB', 'test' Table to update in the database
