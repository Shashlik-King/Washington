...
data.id                         = 'L1GW01'; % Id to store into the database   
data.revision.global            = 71;   % global revision no. for selected location to be used,
...
data.revision.output            = 71;             % revision no. for storing results into the database  
...
settings.db_user                ='hdec_user';        % Database user
settings.db_pass                ='ituotdhdecdb';  % Database pass
settings.db_name                ='hdecdb';     % Database name                                      
%--------------------------------------------------------------------------
...
settings.SESAM                  = 1;        % Export Linearised springs for SESAM
