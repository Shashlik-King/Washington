...
zone=1;
ID_Soil_in_db='Z4_L11';

WTGlocation={'05',	'07',	'09'};
...
data.location                   = ['FD1-',WTGlocation{loc}];   % 'Project location'
data.db_location                = ['FD1-',WTGlocation{loc}];
...
data.id                         =['FD1-',WTGlocation{loc}]; % Id to store into the database   
