...
Water_Depth='Shallow' ;   %'DEEP' or   'Shallow'
ID ={'EW1-04'}; % API Loads received 2020-11-06
...
%% Soil and pile input
%--------------------------------------------------------------------------
settings.database               = 'Database';       % if 'Database' the database module is activated. If 'Manual' input is taken from manual_data_input.xlsx
...
%--------------------------------------------------------------------------
settings.nelem_factor           = 4;        % [m-1] minimum number of pile beam elements per meter 2.2
