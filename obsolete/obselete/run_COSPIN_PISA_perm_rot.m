...
ID ={'A21_PISA_rule_BE_28_char'}; % API Loads received 2020-11-06
...
loads.n_cycles                  = 10000;      % Number of cycles, relevant for Stiff clay w/o water only!
loads.A                         = 'TUHH';    % use API or TUHH (Dührkop) approach for determination of A, relevant for API/Kirsch sand
