...
% ID ={'L0GW01_BE_PISA_ruled_lab_data'}; % API Loads received 2020-10-29
ID ={'A21_rev00_UN_B_odeo'}; % API Loads received 2020-10-29
% ID ={'A21_rev00_UN_B'}; % API Loads received 2020-11-06
% ID ={'L0GW01_BE_PISA_ruled', 'L0GW01_BE_PISA_ruled_new_G0'}; % API Loads received 2020-11-06
...
if plots.load_deflection == 1 || plots.load_deflection_axial == 1
	settings.max_load_ratio     = 25;       % attempts to apply a load equal to the one imported from Excel/database multiplied by this factor
end
%--------------------------------------------------------------------------
%% Output files
%--------------------------------------------------------------------------
