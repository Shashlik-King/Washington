...
loads.A                         = 'API';    % use API or TUHH (D�hrkop) approach for determination of A, relevant for API/Kirsch sand
...
settings.ULS                    = 0;        % 1 = Integration of mobilisable soil resistance in accordance with EA-Ph�hle approach is plotted, 0 = no plot
