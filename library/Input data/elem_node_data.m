...
%         element.delta_phi(nel_tot+1:nel_tot+nel(i))     = 0;
        ...
        element.Np(nel_tot+1:nel_tot+nel(i))            = 0; % MDGI
...
%         element.delta_eff(nel_tot+1:nel_tot+nel(i))     = soil.delta_eff(soil_index);
        ...
        element.Np(nel_tot+1:nel_tot+nel(i))            = soil.Np(soil_index); %MDGI
...
element.Np                      = element.Np(1:nel_tot);
...
element.Np                      = [element.Np(1:nel_tot); element.Np(end)];
