...
#           2016-03-23 (Martin Kelm)    adapted to Hohe See
#
##############################################################################
#
#  
...
our $sec_order_factor 	= 1.0;		# Not used at Hohe See: factor (10%) applied on characteristic ULS overturning moment to account for Alstom load factor and 2nd order effect
...
our $target_eigenfreq_shallow = 0.250;
our $target_eigenfreq_deep    = 0.248;
...
#	print "\\lhead{\\scriptsize \\sf\\hspace{-4cm}  - TP and MP - Detailed Design Report / Appendix $INPUT_LOC}\n";
    $code .=  "\\rhead{\\scriptsize\\sf\\hspace{$indentspace cm} \\includegraphics[height=0.3cm]{../resources/cowi-logo.pdf} \\hspace*{0.9cm} \\\\ Detailed Design Report / Appendix $MP_ID_STR \\hspace{0.7cm} \\arabic{page}}\n";	
...
#	print "\\lfoot{\\sf\\hspace{-4cm}\\tiny G/DAT/Prj/214_PNE_OWP_GWII_Ausfuerung/05 Berichte/...  }\n";#  ...\\tiny $path}\n; # ".$indentspace."
	...
	my $sum_code = build_summary( \%sections, $MP_ID, $MP_STRUCT_REV, $LOC, $TP_TYPE, $TP_STRUCT_REV );
	...
	my $filename   = "$prj_no-RE-0001-APP-$MP_ID-draft"; 
...
sub usage
{
	print STDERR "USAGE: $scriptname <loc> <rev_conf>\n";
	exit 0;
}
...
{	
	...
	my $t = "{\\small MARCH 2016}\\\\{\\small GEOSEA}\\vspace*{3ex}\\\\{\\Huge ENBW HOHE SEE OWF}\\vspace*{3ex}\\\\{\\small DETAILED FOUNDATION DESIGN}\\vspace*{2ex}\\\\\\textbf{\\small DESIGN REPORT PRIMARY STEEL - APPENDIX $MP_ID_STR}";
	...
	$code .= " \\> \\\\\n";
	$code .= "\\textcolor{red}{DOCUMNENT NO.}        \\> XXXXXXX\\\\\n";
	$code .= " \\> \\\\\n";
	$code .= "\\textcolor{red}{VERSION}              \\> 0.1\\\\\n";
	$code .= " \\> \\\\\n";
	$code .= "\\textcolor{red}{DATE OF ISSUE}        \\> XXXX-XX-XX\\\\\n";
	$code .= " \\> \\\\\n";
	$code .= "\\textcolor{red}{PREPARED}             \\> XXXX\\\\\n";
	$code .= " \\> \\\\\n";
	$code .= "\\textcolor{red}{CHECKED}              \\> XXXX\\\\\n";
	$code .= " \\> \\\\\n";
	$code .= "\\textcolor{red}{APPROVED}             \\> XXXX\\\\\n";
	$code .= "\\end{tabbing}\n";
...
sub build_summary
{
	...
	$code .= build_table_sum( $MP_ID, $LOC, $TP_TYPE );
	...
	$code .= build_table_dim( $MP_ID, $MP_STRUCT_REV, $TP_TYPE, $TP_STRUCT_REV );
...
sub build_table_sum 
{
	...
	my @row_names = ( "\\cellcolor{dgrey}Location", 
		...
		"\\cellcolor{dgrey}Original sea floor level [m LAT]" );
...
sub build_table_dim 
{
		...
		my $mcol3 = "\\parbox{1.5cm}{Diameter [mm]}";
