...
%         end
        upy_top(c,:) = [0 0.0001 0.0005 0.005 0.01 0.0125 0.015 0.02 0.04 0.080 0.12 0.2 0.4 1.2 1.4 7.2 10];
        upy_bot(c,:) = upy_top(c,:);
%         upy_top(c,:) = [0 0.00000005 0.0001 0.0003 0.0005 0.00075 0.001 0.002 0.003 0.004 0.005 0.0075 0.01 0.01125 0.0125 0.01375 0.015 0.0175 0.02 0.025 0.03 0.035 0.04 0.05 0.06 0.07 0.080 0.1 0.12 0.16 0.2 0.3 0.4];
%         upy_bot(c,:) = upy_top(c,:);
        y_tot(c,1) = yc_top(c);
    ...
    elseif strcmp(element.model_py(c),'Reese stiff clay')
        A_top = min(0.0106*(element.heqv(c,1)/pile.diameter)^3-0.1006*(element.heqv(c,1)/pile.diameter)^2+0.3323*(element.heqv(c,1)/pile.diameter)+0.2042,0.6) ;
        A_bot = min(0.0106*(element.heqv(c,2)/pile.diameter)^3-0.1006*(element.heqv(c,2)/pile.diameter)^2+0.3323*(element.heqv(c,2)/pile.diameter)+0.2042,0.6);
        yc_top(c) = element.epsilon50(c,1)*pile.diameter;
        yc_bot(c) = element.epsilon50(c,2)*pile.diameter;
        yp_top(c) = 4.1*A_top*yc_top(c);
        yp_bot(c) = 4.1*A_bot*yc_bot(c);
        upy_top(c,:) = [0 0.0001 0.0005 0.001 0.003 0.005 0.01 0.0125 0.015 0.02 0.03 0.04 0.06 0.080 0.12 0.2 0.4 0.6 0.8 1 2];
        upy_bot(c,:) = upy_top(c,:);
%         upy_top(c,:) = [0 0.00000005 0.0001 0.0003 0.0005 0.00075 0.001 0.002 0.003 0.004 0.005 0.0075 0.01 0.01125 0.0125 0.01375 0.015 0.0175 0.02 0.025 0.03 0.035 0.04 0.05 0.06 0.07 0.080 0.1 0.12 0.16 0.2 0.3 0.4];
%         upy_bot(c,:) = upy_top(c,:);
        y_tot(c,1) = yp_top(c);
    ...
    elseif strcmp(element.model_py(c),'Modified Weak rock')
        yrm(c) = element.k_rm(c)*pile.diameter;
        upy_top(c,:) = [0 0.0001 0.0005 0.001 0.003 0.005 0.01 0.0125 0.015 0.02 0.03 0.04 0.06 0.080 0.12 0.2 0.4];
        upy_bot(c,:) = upy_top(c,:);
%         upy_top(c,:) = [0 0.00000005 0.0001 0.0003 0.0005 0.00075 0.001 0.002 0.003 0.004 0.005 0.0075 0.01 0.01125 0.0125 0.01375 0.015 0.0175 0.02 0.025 0.03 0.035 0.04 0.05 0.06 0.07 0.080 0.1 0.12 0.16 0.2 0.3 0.4];
%         upy_bot(c,:) = upy_top(c,:);
