function [kstop ksbot] = apiclaysec_axial(settings,element,pile,reduction,plug_unplug,loads,z_topbottom,A,fs,i,ii)
%--------------------------------------------------------------------------
% PURPOSE
...
% kstop is the tangent stiffness between the origo and the first point defined  
% on the t-z curve. 
% Similar for kbot
